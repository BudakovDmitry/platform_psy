...
import bgImage from "@/public/diary_bg_6.jpg";
...
import {DiaryOfGoodnessType, DiarySuccessType} from "@/app/types/types";
...
const DiaryOfGoodness = () => {
    ...
    const sendDiaryEntry = () => {
        ...
        dispatch(addDiarySuccess({
            ...user,
            diaryOfGoodness: [...user.diaryOfGoodness, {
                ...diaryEntryValue,
                _id: uuidv4()
            }]
        }));
    ...
    return (
        <div className='relative w-full'>
            ...
            <div className='px-10 py-6 min-h-screen z-1 relative'>
                ...
                >
                    <CardBody>
                        <h1 className='text-center font-bold'>{`${user.diaryOfGoodness.length ? 'Продовжи' : 'Почни'} заповнювати свій щоденник`}</h1>
                    </CardBody>
                </Card>
                ...
                <ScrollShadow hideScrollBar className='h-[500px]'>
                    ...
                    >
                        <CardBody className='p-10'>
                            <h2 className='text-center font-bold mb-14 text-xl'>{user.name}, це твій щоденник блага</h2>
                            {user.diaryOfGoodness.length ? [...user.diaryOfGoodness].reverse().map((item: DiaryOfGoodnessType)  => {
...
export default DiaryOfGoodness;