        ...
        return (
            <div className="col-start-6 col-end-13 p-3 rounded-lg">
                <div className="flex items-center justify-start flex-row-reverse">
                    <Avatar className='min-w-unit-10' isBordered radius="md" src={`${API_URL}${Endpoints.AVATAR}/${currentUser.avatar}`} />
                    <div
    ...
    return (
        <div className="col-start-1 col-end-8 p-3 rounded-lg">
            <div className="flex flex-row items-center">
                <Avatar className='min-w-unit-10' isBordered radius="md" src={`${API_URL}${Endpoints.AVATAR}/${companionUser.avatar}`} />
                <div
